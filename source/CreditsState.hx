...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
			...
			['Mod Team'],
			['Kipan',		    'kipan',		    'The Coder/Animator',	 'https://youtube.com/channel/UCwkLz47Q-VvZpMczo5HBjFA',	'0xFFFF2631'],
			['RedStoneCraft GG',		    'redstonecraftgg',		    'Make Song',	 'https://youtube.com/c/RedStoneCraftGG',	'0xFFFF000D'],
			['Psych Engine Team'],
